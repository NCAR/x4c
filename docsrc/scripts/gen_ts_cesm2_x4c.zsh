...
# =====================================================================
cat >! ${task_name}_ocn_${syr}-${eyr}.py << EOF
import os
import x4c
import time
...
dirpath = '$hist_root/$casename'
case = x4c.History(dirpath, casename='$casename', cesm_ver=2)
...
# load modules
# =====================================================================
cat >! ${task_name}_ocn_${syr}-${eyr}.pbs << EOF
#!/bin/bash
#PBS -N ${task_name}_ocn_${syr}-${eyr}
#PBS -q main
...
python ${task_name}_ocn_${syr}-${eyr}.py
EOF
...
# submit the job
# =====================================================================
qsub ${task_name}_ocn_${syr}-${eyr}.pbs
